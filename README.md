...
## Requirements
  ...
  - **Homebrew**: Requires `homebrew` already installed (you can use `schilton.homebrew` to install it on your Mac).
...
## Dependencies
  ...
  - (Soft dependency) `schilton.homebrew`
...
See the [Mac Development Ansible Playbook](https://github.com/schilton/MyMacBook) for an example of this role's usage.
...
This role was created in 2018 by [Scott Chilton] based on the original work of [Jeff Geerling](https://www.jeffgeerling.com/), author of [Ansible for DevOps](https://www.ansiblefordevops.com/).
